...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Galgotias College of Engineering and Technology, Greater Noida",
    description: [
      ...
      "Participated as a Student Member in IEEE (Institute of Electrical and Electronics Engineers).",
    ],
    skills: [
      SkillNames.TS,
      SkillNames.REACT,
  ...
  },
  {
    ...
    startDate: "2023",
    endDate: "Present",
    title: "AI & Content Certifications",
